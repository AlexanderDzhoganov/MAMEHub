...
emcc --bind -g -O3 -s DISABLE_EXCEPTION_CATCHING=0 -s USE_PTHREADS=0 -s USE_SDL=2 -s USE_SDL_TTF=2 -s USE_ZLIB=1 -s ASSERTIONS=2 -s WASM=1 -s ALLOW_MEMORY_GROWTH=1 mamecps1.bc -o mamecps1.js
